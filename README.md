...
- [x] Satellitendaten von Kalifornien [data not filtered]
- [x] Sensordaten: England, DE, Holland (Copernicus) [data for ENG, NL not filtered]
- [ ] Visualisierung (Statisch)
- [ ] Error analysis 
...
- [x] Disaggregation mit Cogran (Wie/Wo/Was)
- [x] Orte finalisieren
